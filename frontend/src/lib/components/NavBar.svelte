...
<nav class="bg-indigo-600 dark:bg-indigo-800">
  <div class="shell flex h-16 items-center justify-between">
    <a href="/" use:link class="text-xl font-black text-white no-underline">Zeteo</a>
    ...
    <button
      ...
      class="relative inline-flex items-center justify-center rounded-md bg-indigo-600 p-2 text-indigo-200 hover:bg-indigo-500/75 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-white md:hidden dark:bg-indigo-800 dark:hover:bg-indigo-700/75"
